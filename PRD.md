...
`Hero → Обо мне → Таймлайн опыта → Пет-проекты → Контакты`
...
- Указатель вниз: «Полный опыт ниже» (стрелка / скролл-хинт).
...
### 3.5 Функция: Пет-проекты / чем занимаюсь в свободное время
...
### 5.5 Сопоставление моделей и компонентов (терминология)
...
| **M4. Пет-проекты + Контакты** | Карточки проектов, блок контактов, защита email | §3.5–3.6 AC выполнены |
